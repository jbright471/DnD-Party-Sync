...
import { normaliseCharacter, normaliseTrackerEntity, TABS } from './utils/helpers';
...
function App() {
  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      {isDm ? (
        ...
        <>
          ...
          <div className="flex-1 flex flex-col lg:grid lg:grid-cols-[250px_minmax(0,1fr)_300px] overflow-hidden">
            ...
            {/* Top/Left Pane: Party Tracker */}
            <aside className="flex-none lg:flex lg:flex-col lg:h-full bg-gray-900 border-b lg:border-b-0 lg:border-r border-dnd-border z-10 shadow-md lg:shadow-none">
              <PartySidebar
                party={party}
            ...
            {/* Right Pane: Log (Dice Tray Removed) */}
      ...
      <DiceRoller characterName={selectedCharacter ? selectedCharacter.name : "Player"} isDm={isDm} />
      <RulesAssistant />
